...
StaticTargetData const staticTargetData[TOTAL_SPELL_TARGETS] =
{
    ...
    {TARGET_OBJECT_TYPE_DEST, TARGET_REFERENCE_TYPE_CASTER, TARGET_SELECT_CATEGORY_DEFAULT, TARGET_CHECK_DEFAULT,  TARGET_DIR_NONE},        // 137 TARGET_DYNAMINC_MOV_FLAGS
...
bool SpellInfo::BreaksInstantlyOnDamage() const
{
    switch (Id)
    {
        case 2637:   // Hibernate
        case 19386:  // Wyvert String
        case 33396:  // Freeze (Elemental)
...
bool SpellInfo::CanBreakCC(Unit* caster) const
{
    if (IsPoisonOrBleedSpell() && caster->HasAura(108216))
        return false;
