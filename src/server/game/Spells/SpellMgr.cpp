...
void SpellMgr::LoadSpellCustomAttr()
{
    ...
    for (uint32 i = 0; i < GetSpellInfoStoreSize(); ++i)
    {
        for (int difficulty = 0; difficulty < MAX_DIFFICULTY; difficulty++)
        {
            ...
            case 134169: // Disintegration Beam
                spellInfo->Effects[EFFECT_0].TargetA = TARGET_UNIT_TARGET_ANY;
                break;
            case 138118: // Siphon Anima
            case 138378:
            ...
            case 108503:// Grimoire of Sacrifice
                spellInfo->AttributesEx2 |= SPELL_ATTR2_CAN_TARGET_NOT_IN_LOS;
                break;
            case 119898: // Command Demon
                spellInfo->OverrideSpellList.push_back(119905);
                spellInfo->OverrideSpellList.push_back(119907);
                spellInfo->OverrideSpellList.push_back(119909);
                spellInfo->OverrideSpellList.push_back(119910);
                spellInfo->OverrideSpellList.push_back(119911);
                spellInfo->OverrideSpellList.push_back(119913);
                spellInfo->OverrideSpellList.push_back(119914);
                spellInfo->OverrideSpellList.push_back(119915);
                break;
            ...
            case 150017:
                spellInfo->Effects[EFFECT_2].Effect = 0;
                break;
            case 126578: // Conjure Familiar
                spellInfo->Effects[EFFECT_0].Effect = SPELL_EFFECT_CREATE_RANDOM_ITEM;
                break;
            case 148008: // Yu-Lon Cloak effect damage
                spellInfo->AttributesEx3 &= ~SPELL_ATTR3_NO_DONE_BONUS;
                spellInfo->AttributesEx6 &= ~SPELL_ATTR6_NO_DONE_PCT_DAMAGE_MODS;
                break;
            case 120696: // Halo heal and damage effect
            case 120692:
                spellInfo->Effects[EFFECT_0].SetRadiusIndex(10); // 30 yds
                spellInfo->Effects[EFFECT_0].TargetA = TARGET_SRC_CASTER;
                spellInfo->Effects[EFFECT_0].TargetB = TARGET_UNIT_SRC_AREA_ALLY;
                spellInfo->Effects[EFFECT_1].SetRadiusIndex(10); // 30 yds
                spellInfo->Effects[EFFECT_1].TargetA = TARGET_SRC_CASTER;
                spellInfo->Effects[EFFECT_1].TargetB = TARGET_UNIT_SRC_AREA_ENEMY;
                break;
            case 120517: // Halo
            case 120644:
                ...
                spellInfo->Effects[EFFECT_0].TargetA = TARGET_UNIT_CASTER;
                break;
            case 120361: // Barrage dmg
                spellInfo->Effects[EFFECT_2].BasePoints = 35;
                break;
            case 430: // Drink
            case 431:
            case 432:
            ...
            case 130336:
                spellInfo->AttributesEx5 |= SPELL_ATTR5_START_PERIODIC_AT_APPLY;
                break;
            case 87806: // Seafood Magnifique Feast - cata
                spellInfo->Effects[EFFECT_0].Effect = SPELL_EFFECT_TRIGGER_SPELL;
                spellInfo->Effects[EFFECT_0].TargetA = TARGET_UNIT_CASTER;
                spellInfo->Effects[EFFECT_0].TriggerSpell = 80169;
                spellInfo->Effects[EFFECT_1].Effect = SPELL_EFFECT_TRIGGER_SPELL;
                spellInfo->Effects[EFFECT_1].TargetA = TARGET_UNIT_CASTER;
                spellInfo->Effects[EFFECT_1].TriggerSpell = 80167;
                ...
                spellInfo->Attributes |= SPELL_ATTR0_HIDDEN_CLIENTSIDE; // @todo : Why ClientSide Attributes not work
                spellInfo->AttributesEx2 |= SPELL_ATTR2_FOOD_BUFF;
                spellInfo->MaxAffectedTargets = 1;
                break;
            case 87763: // Broiled Dragon Feast - cata
                spellInfo->Effects[EFFECT_0].Effect = SPELL_EFFECT_TRIGGER_SPELL;
                spellInfo->Effects[EFFECT_0].TargetA = TARGET_UNIT_CASTER;
                spellInfo->Effects[EFFECT_0].TriggerSpell = 80168;
                spellInfo->Effects[EFFECT_1].Effect = SPELL_EFFECT_TRIGGER_SPELL;
                spellInfo->Effects[EFFECT_1].TargetA = TARGET_UNIT_CASTER;
                spellInfo->Effects[EFFECT_1].TriggerSpell = 80166;
                spellInfo->Effects[EFFECT_2].Effect = SPELL_EFFECT_APPLY_AURA;
                spellInfo->Effects[EFFECT_2].ApplyAuraName = SPELL_AURA_PERIODIC_TRIGGER_SPELL;
                spellInfo->Effects[EFFECT_2].TargetA = TARGET_UNIT_CASTER;
                spellInfo->Effects[EFFECT_2].TriggerSpell = 0;
                ...
                spellInfo->MaxAffectedTargets = 1;
                break;
            case 126541: // Banquet of the Wok - mop
            case 126544: // Banquet of the oven - mop
            case 126532: // Banquet of the Grill - mop
            case 126543: // Banquet of the Steamer - mop
            case 126542: // Banquet of the Pot - mop
                spellInfo->Effects[EFFECT_0].Effect = SPELL_EFFECT_TRIGGER_SPELL;
                spellInfo->Effects[EFFECT_0].TargetA = TARGET_UNIT_CASTER;
                spellInfo->Effects[EFFECT_0].TriggerSpell = 104934;
                spellInfo->Effects[EFFECT_1].Effect = SPELL_EFFECT_TRIGGER_SPELL;
                spellInfo->Effects[EFFECT_1].TargetA = TARGET_UNIT_CASTER;
                spellInfo->Effects[EFFECT_1].TriggerSpell = 104269;
                spellInfo->Effects[EFFECT_2].Effect = SPELL_EFFECT_APPLY_AURA;
                spellInfo->Effects[EFFECT_2].ApplyAuraName = SPELL_AURA_PERIODIC_TRIGGER_SPELL;
                spellInfo->Effects[EFFECT_2].TargetA = TARGET_UNIT_CASTER;
                spellInfo->Effects[EFFECT_2].TriggerSpell = 0;
                ...
                spellInfo->MaxAffectedTargets = 1;
                break;
            case 126545: // Banquet of the Brew
            case 104924: // Pandaren Banquet
                spellInfo->Effects[EFFECT_0].Effect = SPELL_EFFECT_TRIGGER_SPELL;
                spellInfo->Effects[EFFECT_0].TargetA = TARGET_UNIT_CASTER;
                spellInfo->Effects[EFFECT_0].TriggerSpell = 104934;
                spellInfo->Effects[EFFECT_1].Effect = SPELL_EFFECT_TRIGGER_SPELL;
